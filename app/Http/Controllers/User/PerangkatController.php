...
class PerangkatController extends Controller
{
    public function index()
    {
        ...
        return view('user.perangkat.index', compact('perangkats'));
    }
    ...
    public function create()
    {
        ...
        return view('user.perangkat.create', compact(
            'karyawans',
            'units',
            'mereks',
            'models',
    ...
    public function store(Request $request)
    {
        ...
        return redirect('user/perangkat');
    }
    ...
    public function show($id)
    {
        ...
        return view('user.perangkat.show', compact('perangkat', 'perbaikans'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('user.perangkat.edit', compact(
            'perangkat',
            'karyawans',
            'units',
            'mereks',
    ...
    public function print($id)
    {
        ...
        $pdf = Pdf::loadview('user.perangkat.print', compact('kode'));
        return $pdf->stream('Kode Perangkat');
    }

    public function scan()
    {
        return view('user.perangkat.scan');
    }
