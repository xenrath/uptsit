...
class SparepartController extends Controller
{
    ...
    public function create()
    {
        ...
        if ($cek) {
            return redirect('admin/sparepart/' . $kategori);
        } else {
    ...
    public function create_motherboard()
    {
        ...
        return view('admin.sparepart.create_motherboard', compact(
            'motherboard_mereks',
            'prosesor_models',
            'ram_tipes'
        ));
    ...
    public function create_prosesor()
    {
        ...
        return view('admin.sparepart.create_prosesor', compact('prosesor_models'));
    }
    ...
    public function create_ram()
    {
        ...
        return view('admin.sparepart.create_ram', compact('ram_mereks', 'ram_tipes', 'ram_kapasitases'));
    }
    ...
    public function create_storage()
    {
        ...
        return view('admin.sparepart.create_storage', compact('storage_mereks', 'storage_kapasitases'));
    }

    public function create_psu()
    {
        return view('admin.sparepart.create_psu');
    }

    public function create_heatsink()
    {
        return view('admin.sparepart.create_heatsink');
    }

    public function create_monitor()
    {
        return view('admin.sparepart.create_monitor');
    }

    public function create_keyboard()
    {
        return view('admin.sparepart.create_keyboard');
    }

    public function create_mouse()
    {
        return view('admin.sparepart.create_mouse');
    }
    ...
    public function edit($id)
    {
        ...
        if ($cek) {
            return redirect('admin/sparepart/' . $kategori . '/' . $id);
        } else {
            return view('error.500');
        }
    }
    ...
    public function edit_motherboard($id)
    {
        ...
        return view('admin.sparepart.edit_motherboard', compact(
            'sparepart',
            'motherboard_mereks',
            'prosesor_models',
            'ram_tipes'
    ...
    public function edit_prosesor($id)
    {
        ...
        return view('admin.sparepart.edit_prosesor', compact('sparepart', 'prosesor_models'));
    }
    ...
    public function edit_ram($id)
    {
        ...
        return view('admin.sparepart.edit_ram', compact('sparepart', 'ram_mereks', 'ram_tipes', 'ram_kapasitases'));
    }
    ...
    public function edit_storage($id)
    {
        ...
        return view('admin.sparepart.edit_storage', compact('sparepart', 'storage_mereks', 'storage_kapasitases'));
    }
    ...
    public function edit_psu($id)
    {
        ...
        return view('admin.sparepart.edit_psu', compact('sparepart'));
    }
    ...
    public function edit_heatsink($id)
    {
        ...
        return view('admin.sparepart.edit_heatsink', compact('sparepart'));
    }
    ...
    public function edit_monitor($id)
    {
        ...
        return view('admin.sparepart.edit_monitor', compact('sparepart'));
    }
    ...
    public function edit_keyboard($id)
    {
        ...
        return view('admin.sparepart.edit_keyboard', compact('sparepart'));
    }
    ...
    public function edit_mouse($id)
    {
        ...
        return view('admin.sparepart.edit_mouse', compact('sparepart'));
    }
