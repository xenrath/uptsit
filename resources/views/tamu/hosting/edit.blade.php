            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <select class="custom-select" id="kategori" name="kategori">
                  ...
                  <option value="baru" {{ old('kategori', $hosting->kategori) == 'baru' ? 'selected' : '' }}>Baru
                  </option>
                  <option value="perubahan" {{ old('kategori', $hosting->kategori) == 'perubahan' ? 'selected' : '' }}>
                    Perubahan</option>
                  <option value="penambahan" {{ old('kategori', $hosting->kategori) == 'penambahan' ? 'selected' : '' }}>
                    Penambahan</option>
                </select>
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="nama_instansi" name="nama_instansi"
                  placeholder="Masukan Nama Instansi" value="{{ old('nama_instansi', $hosting->nama_instansi) }}">
              </div>
            </div>
          </div>
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="nama_kepala" name="nama_kepala" placeholder="Masukan Nama"
                  value="{{ old('nama_kepala', $hosting->nama_kepala) }}">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="nipy_kepala" name="nipy_kepala" placeholder="Masukan NIPY"
                  value="{{ old('nipy_kepala', $hosting->nipy_kepala) }}">
              </div>
              <div class="form-group">
                <label for="jabatan_kepala">Jabatan *</label>
                <input type="text" class="form-control" id="jabatan_kepala" name="jabatan_kepala"
                  placeholder="Masukan Jabatan" value="{{ old('jabatan_kepala', $hosting->jabatan_kepala) }}">
              </div>
            </div>
          </div>
              ...
              <div class="form-group">
                ...
                <div class="input-group mb-3">
                  ...
                  <input type="text" id="telp_admin_1" name="telp_admin_1" class="form-control"
                    placeholder="Masukan Nomor Telepon" value="{{ old('telp_admin_1', $hosting->telp_admin_1) }}">
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="nama_admin_2" name="nama_admin_2"
                  placeholder="Masukan Nama" value="{{ old('nama_admin_2', $hosting->nama_admin_2) }}">
              </div>
              <div class="form-group">
                <label for="nipy_admin">NIPY *</label>
                <input type="text" class="form-control" id="nipy_admin_2" name="nipy_admin_2"
                  placeholder="Masukan NIPY" value="{{ old('nipy_admin_2', $hosting->nipy_admin_2) }}">
              </div>
              <div class="form-group">
                <label for="jabatan_admin">Jabatan *</label>
                <input type="text" class="form-control" id="jabatan_admin_2" name="jabatan_admin_2"
                  placeholder="Masukan Jabatan" value="{{ old('jabatan_admin_2', $hosting->jabatan_admin_2) }}">
              </div>
              <div class="form-group">
                <label for="email_admin">Email *</label>
                <input type="text" class="form-control" id="email_admin_2" name="email_admin_2"
                  placeholder="Masukan Email" value="{{ old('email_admin_2', $hosting->email_admin_2) }}">
              </div>
              <div class="form-group">
                <label for="telp_admin">No. Telepon *</label>
                <div class="input-group mb-3">
                  ...
                  <input type="text" id="telp_admin_2" name="telp_admin_2" class="form-control"
                    placeholder="Masukan Nomor Telepon" value="{{ old('telp_admin_2', $hosting->telp_admin_2) }}">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <textarea type="text" class="form-control" id="deskripsi" name="deskripsi" placeholder="Masukan Deskripsi">{{ old('deskripsi', $hosting->deskripsi) }}</textarea>
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="sub_domain" name="sub_domain"
                  placeholder="Masukan Sub Domain" value="{{ old('sub_domain', $hosting->sub_domain) }}">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="ip_address" name="ip_address"
                  data-inputmask="'alias': 'ip'" data-mask value="{{ old('ip_address', $hosting->ip_address) }}">
              </div>
              <div class="form-group">
                <label for="ftp">
                  FTP / DB
                ...
                <input type="text" class="form-control" id="ftp" name="ftp" placeholder="Masukan FTP"
                  value="{{ old('ftp', $hosting->ftp) }}">
              </div>
            </div>
          </div>
          <div class="card">
            <div class="card-footer">
              <button type="submit" class="btn btn-primary btn-block">Perbarui Permohonan</button>
            </div>
          </div>
        </form>
      </div>
