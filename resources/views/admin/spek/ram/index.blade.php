    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Spesifikasi RAM</h1>
                    </div>
                    <!-- /.col -->
                </div>
                <!-- /.row -->
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Spesifikasi RAM</h3>
                    ...
                    <div class="card-body">
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                @foreach ($spek_rams as $spek_ram)
                                    <tr>
                                        <td class="text-center">{{ $loop->iteration }}</td>
                                        <td>
                                            {{ $spek_ram->nama }}
                                            <br class="d-block d-lg-none">
                                            <span class="text-muted">({{ ucfirst($spek_ram->kategori) }})</span>
                                        </td>
                                        <td class="text-center">
                                            <button type="button" class="btn btn-warning btn-sm btn-flat mb-2"
                                                data-toggle="modal"
                                                data-target="#modal-edit-{{ $spek_ram->id }}">
                                                <i class="fas fa-pen"></i>
                                            </button>
                                            <button type="button" class="btn btn-danger btn-sm btn-flat mb-2"
                                                data-toggle="modal"
                                                data-target="#modal-hapus-{{ $spek_ram->id }}">
                                                <i class="fas fa-trash"></i>
                                            </button>
                                        </td>
                                    </tr>
                                    <div class="modal fade" id="modal-edit-{{ $spek_ram->id }}">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form
                                                    action="{{ url('admin/spek-ram/' . $spek_ram->id) }}"
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group mb-2">
                                                            ...
                                                            <select
                                                                ...
                                                                @if (session('id') == $spek_ram->id) @error('kategori') is-invalid @enderror @endif"
                                                                id="kategori" name="kategori">
                                                                <option value="">- Pilih -</option>
                                                                <option value="tipe"
                                                                    {{ $spek_ram->kategori == 'tipe' ? 'selected' : '' }}>
                                                                    Tipe</option>
                                                                <option value="merek"
                                                                    {{ $spek_ram->kategori == 'merek' ? 'selected' : '' }}>
                                                                    Merek</option>
                                                            </select>
                                                            @if (session('id') == $spek_ram->id)
                                                                @error('kategori')
                                                        ...
                                                        <div class="form-group mb-2">
                                                            ...
                                                            <input type="text"
                                                                class="form-control rounded-0  @if (session('id') == $spek_ram->id) @error('nama') is-invalid @enderror @endif"
                                                                id="nama" name="nama"
                                                                value="{{ $spek_ram->nama }}">
                                                            @error('nama')
                                                                <div class="invalid-feedback">
                                    ...
                                    <div class="modal fade" id="modal-hapus-{{ $spek_ram->id }}">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    <p>Yakin hapus spesifikasi RAM
                                                        <strong>{{ $spek_ram->nama }}</strong>?
                                                    </p>
                                                </div>
                                                <div class="modal-footer justify-content-between">
                                                    <button type="button" class="btn btn-default btn-sm btn-flat"
    ...
    <div class="modal fade" id="modal-tambah">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ url('admin/spek-ram') }}" method="POST" autocomplete="off">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group mb-2">
                            <label for="kategori">Kategori</label>
