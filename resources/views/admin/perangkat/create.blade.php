                                        ...
                                        <select class="custom-select rounded-0 @error('unit_id') is-invalid @enderror"
                                            ...
                                            @foreach ($units as $unit)
                                                <option value="{{ $unit->id }}"
                                                    {{ old('unit_id') == $unit->id ? 'selected' : '' }}>{{ $unit->nama }}
                                                </option>
                                            @endforeach
                                        </select>
                                        @error('unit_id')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-2">
                                        ...
                                        <select class="custom-select rounded-0 @error('jenis') is-invalid @enderror"
                                            ...
                                            <option value="">- Pilih -</option>
                                            <option value="pc" {{ old('jenis') == 'pc' ? 'selected' : '' }}>PC</option>
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <select class="custom-select rounded-0 @error('merek') is-invalid @enderror"
                                            ...
                                            @foreach ($mereks as $merek)
                                                <option value="{{ $merek->keterangan }}">{{ $merek->keterangan }}</option>
                                            @endforeach
                                        ...
                                        <select class="custom-select rounded-0 @error('model') is-invalid @enderror"
                                            ...
                                            @foreach ($models as $model)
                                                <option value="{{ $model->keterangan }}"
                                                    {{ old('model') == $model->keterangan ? 'selected' : '' }}>
                                                    {{ $model->keterangan }}
                                                </option>
                                            @endforeach
                                ...
                                <select class="custom-select rounded-0 @error('ram_tipe') is-invalid @enderror"
                                    ...
                                    @foreach ($ram_tipes as $ram_tipe)
                                        <option value="{{ $ram_tipe->keterangan }}"
                                            {{ old('ram_tipe') == $ram_tipe->keterangan ? 'selected' : '' }}>
                                            {{ $ram_tipe->keterangan }}
                                        </option>
                                    @endforeach
                                        ...
                                        <select
                                            ...
                                            @foreach ($ram_kapasitases as $ram_kapasitas)
                                                <option value="{{ $ram_kapasitas->keterangan }}"
                                                    {{ old('ram_kapasitas') == $ram_kapasitas->keterangan ? 'selected' : '' }}>
                                        ...
                                        <select class="custom-select rounded-0 @error('ram_merek') is-invalid @enderror"
                                            ...
                                            @foreach ($ram_mereks as $ram_merek)
                                                <option value="{{ $ram_merek->keterangan }}"
                                                    {{ old('ram_merek') == $ram_merek->keterangan ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-2">
                                            ...
                                            <select
                                                ...
                                                @foreach ($ram_kapasitases as $ram_kapasitas)
                                                    <option value="{{ $ram_kapasitas->keterangan }}"
                                                        {{ old('ram_tambahan_kapasitas') == $ram_kapasitas->keterangan ? 'selected' : '' }}>
                                                        {{ $ram_kapasitas->keterangan }} GB
                                                    </option>
                                                @endforeach
                                                <option value="lainnya"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-2">
                                            ...
                                            <select
                                                ...
                                                @foreach ($ram_mereks as $ram_merek)
                                                    <option value="{{ $ram_merek->keterangan }}"
                                                        {{ old('ram_tambahan_merek') == $ram_merek->keterangan ? 'selected' : '' }}>
                                                        {{ $ram_merek->keterangan }}
                                                    </option>
                                                @endforeach
                                                <option value="lainnya"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-2">
                                        ...
                                        <select
                                            ...
                                            <option value="">- Pilih -</option>
                                            <option value="HDD" {{ old('storage_tipe') == 'HDD' ? 'selected' : '' }}>
                                                HDD</option>
                                            <option value="SSD" {{ old('storage_tipe') == 'SSD' ? 'selected' : '' }}>
                                                SSD</option>
                                        </select>
                                        @error('storage_tipe')
                                            <div class="invalid-feedback">
                                        ...
                                        <select
                                            ...
                                            @foreach ($storage_kapasitases as $storage_kapasitas)
                                                <option value="{{ $storage_kapasitas->keterangan }}"
                                                    {{ old('storage_kapasitas') == $storage_kapasitas->keterangan ? 'selected' : '' }}>
                                        ...
                                        <select
                                            ...
                                            @foreach ($storage_mereks as $storage_merek)
                                                <option value="{{ $storage_merek->keterangan }}"
                                                    {{ old('storage_merek') == $storage_merek->keterangan ? 'selected' : '' }}>
                            ...
                            <div class="form-group mb-2">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" id="is_storage_tambahan"
                                        ...
                                        {{ old('is_storage_tambahan') ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-2">
                                            ...
                                            <select
                                                ...
                                                <option value="">- Pilih -</option>
                                                <option value="HDD"
                                                    {{ old('storage_tambahan_tipe') == 'HDD' ? 'selected' : '' }}>HDD
                                                </option>
                                                <option value="SSD"
                                                    {{ old('storage_tambahan_tipe') == 'SSD' ? 'selected' : '' }}>SSD
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-2">
                                            ...
                                            <select
                                                ...
                                                @foreach ($storage_kapasitases as $storage_kapasitas)
                                                    <option value="{{ $storage_kapasitas->keterangan }}"
                                                        {{ old('storage_tambahan_kapasitas') == $storage_kapasitas->keterangan ? 'selected' : '' }}>
                                                        {{ $storage_kapasitas->keterangan }} GB
                                                    </option>
                                                @endforeach
                                                <option value="lainnya"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-2">
                                            ...
                                            <select
                                                ...
                                                @foreach ($storage_mereks as $storage_merek)
                                                    <option value="{{ $storage_merek->keterangan }}"
                                                        {{ old('storage_tambahan_merek') == $storage_merek->keterangan ? 'selected' : '' }}>
                                                        {{ $storage_merek->keterangan }}
                                                    </option>
                                                @endforeach
                                                <option value="lainnya"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-2">
                                            ...
                                            <input type="text"
                                                ...
                                                id="psu_merek" name="psu_merek" value="{{ old('psu_merek') }}">
                                            @error('psu_merek')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-2">
                                            ...
                                            <input type="text"
                                                ...
                                                id="mouse_merek" name="mouse_merek" value="{{ old('mouse_merek') }}">
                                            @error('mouse_merek')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
...
@section('script')
    <script>
        ...
        function search_karyawan() {
            ...
            $('#modal-loading').show();
            $.ajax({
                url: "{{ url('admin/perangkat/karyawan-search') }}",
                type: "GET",
                data: {
                    "keyword": $('#keyword').val(),
                },
        ...
        function set_karyawan(id, is_old = false) {
            $.ajax({
                url: "{{ url('admin/perangkat/karyawan-set') }}" + "/" + id,
                type: "GET",
                dataType: "json",
                success: function(data) {
                    $('#karyawan_id').empty();
        ...
        var karyawan_id = "{{ old('karyawan_id') }}";
        if (karyawan_id) {
        ...
        var is_ram_tambahan = "{{ old('is_ram_tambahan') }}";
        if (is_ram_tambahan) {
            ram_tambahan();
        }
        ...
        var is_storage_tambahan = "{{ old('is_storage_tambahan') }}";
