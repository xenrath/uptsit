        ...
        <form action="{{ url('admin/unit/update') }}" method="post" enctype="multipart/form-data" autocomplete="off">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control" id="sistem" name="sistem" placeholder="Masukan jumlah sistem"
                value="{{ old('sistem', $unit->sistem) }}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="telp" name="telp" placeholder="Masukan nomor telepon unit"
                value="{{ old('telp', $unit->telp) }}">
            </div>
          </div>
