        ...
        <section class="content">
            <div class="container-fluid">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <form action="{{ url('admin/sparepart/prosesor/' . $sparepart->id) }}" method="post"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" class="form-control rounded-0" value="Prosesor" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-2">
                            ...
                            <div class="form-group mb-2">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" id="is_baru" name="is_baru"
                                        onchange="baru()"
                                        {{ old('is_baru', $sparepart->is_baru) ? 'checked' : '' }}>
