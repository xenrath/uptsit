                                ...
                                @forelse ($spareparts as $sparepart)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="{{ url('admin/sparepart/' . $sparepart->id . '/edit') }}"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer justify-content-between">
                                                    ...
                                                    <form action="{{ url('admin/sparepart/' . $sparepart->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('delete')
                                                        <button type="submit"
    ...
    <div class="modal fade" id="modal-tambah">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ url('admin/sparepart/create') }}" method="GET" autocomplete="off">
                    <div class="modal-body">
