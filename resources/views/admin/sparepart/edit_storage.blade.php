        ...
        <section class="content">
            <div class="container-fluid">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <form action="{{ url('admin/sparepart/storage/' . $sparepart->id) }}" method="post"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-2">
                                        ...
                                        <select class="custom-select rounded-0 @error('tipe') is-invalid @enderror"
                                            ...
                                            <option value="HDD"
                                                {{ old('tipe', $sparepart->tipe) == 'HDD' ? 'selected' : '' }}>
                                                HDD</option>
                                            <option value="SSD"
                                                {{ old('tipe', $sparepart->tipe) == 'SSD' ? 'selected' : '' }}>
                                                SSD</option>
                                        </select>
                                        @error('tipe')
                                        ...
                                        <select class="custom-select rounded-0 @error('merek') is-invalid @enderror"
                                            ...
                                            @foreach ($storage_mereks as $storage_merek)
                                                <option value="{{ $storage_merek->keterangan }}"
                                                    {{ old('merek', $sparepart->merek) == $storage_merek->keterangan ? 'selected' : '' }}>
                                        ...
                                        <select class="custom-select rounded-0 @error('kapasitas') is-invalid @enderror"
                                            ...
                                            @foreach ($storage_kapasitases as $storage_kapasitas)
                                                <option value="{{ $storage_kapasitas->keterangan }}"
                                                    {{ old('kapasitas', $sparepart->kapasitas) == $storage_kapasitas->keterangan ? 'selected' : '' }}>
