        ...
        <section class="content">
            <div class="container-fluid">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <form action="{{ url('admin/sparepart/psu/' . $sparepart->id) }}" method="post"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" class="form-control rounded-0" value="PSU" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-2">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-2">
                                        <label for="kapasitas">
                                            Kapasitas
                                            <small class="text-muted">(satuan: Watt)</small>
                                        </label>
                                        <input type="number"
                                            class="form-control rounded-0 @error('kapasitas') is-invalid @enderror"
                                            id="kapasitas" name="kapasitas"
                                            value="{{ old('kapasitas', $sparepart->kapasitas) }}">
                                        @error('kapasitas')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
