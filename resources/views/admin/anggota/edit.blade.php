    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <a href="{{ url('admin/anggota') }}" class="btn btn-secondary btn-flat float-left mr-2">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <form action="{{ url('admin/anggota/' . $user->id) }}" method="post" enctype="multipart/form-data"
                        autocomplete="off">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            ...
                            <div class="form-group mb-2">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" id="is_cbt" name="is_cbt"
                                        {{ $user->is_cbt ? 'checked' : '' }}>
                                    <label class="custom-control-label" for="is_cbt">Jadikan Petugas CBT</label>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <form action="{{ url('admin/anggota/reset/' . $user->id) }}" method="post">
                        @csrf
