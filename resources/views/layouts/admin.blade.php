  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="" class="brand-link">
        ...
        <span class="brand-text font-wight-bold">Admin SIT</span>
      </a>
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
            ...
            <li class="nav-item">
              <a href="{{ url('admin/pengaduan/menunggu') }}"
                class="nav-link {{ request()->is('admin/pengaduan/menunggu') ? 'active' : '' }}">
            ...
            <li class="nav-item">
              <a href="{{ url('admin/pengaduan/proses') }}"
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>Yakin keluar sistem <strong>Admin SIT</strong>?</p>
          </div>
