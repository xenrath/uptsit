    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <a href="{{ url('user/perbaikan') }}" class="btn btn-secondary btn-flat float-left mr-2">
        ...
        <section class="content">
            <div class="container-fluid">
                <form action="{{ url('user/perbaikan') }}" method="post" enctype="multipart/form-data" id="form-submit"
                    autocomplete="off">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
...
@section('script')
    ...
    <script>
        function set_motherboard(id) {
            $.ajax({
                url: "{{ url('user/perbaikan/motherboard-set') }}" + "/" + id,
                type: "GET",
                dataType: "json",
        ...
        function set_prosesor(id) {
            $.ajax({
                url: "{{ url('user/perbaikan/prosesor-set') }}" + "/" + id,
                type: "GET",
                dataType: "json",
                success: function(data) {
                    if (data) {
        ...
        function set_ram(id) {
            $.ajax({
                url: "{{ url('user/perbaikan/ram-set') }}" + "/" + id,
                type: "GET",
                dataType: "json",
                success: function(data) {
                    if (data) {
        ...
        function set_storage(id) {
            $.ajax({
                url: "{{ url('user/perbaikan/storage-set') }}" + "/" + id,
                type: "GET",
                dataType: "json",
                success: function(data) {
                    if (data) {
        ...
        function set_psu(id) {
            $.ajax({
                url: "{{ url('user/perbaikan/psu-set') }}" + "/" + id,
                type: "GET",
                dataType: "json",
                success: function(data) {
                    if (data) {
        ...
        function set_heatsink(id) {
            $.ajax({
                url: "{{ url('user/perbaikan/heatsink-set') }}" + "/" + id,
                type: "GET",
                dataType: "json",
                success: function(data) {
                    if (data) {
        ...
        function set_monitor(id) {
            $.ajax({
                url: "{{ url('user/perbaikan/monitor-set') }}" + "/" + id,
                type: "GET",
                dataType: "json",
                success: function(data) {
                    if (data) {
        ...
        function set_keyboard(id) {
            $.ajax({
                url: "{{ url('user/perbaikan/keyboard-set') }}" + "/" + id,
                type: "GET",
                dataType: "json",
                success: function(data) {
                    if (data) {
        ...
        function set_mouse(id) {
            $.ajax({
                url: "{{ url('user/perbaikan/mouse-set') }}" + "/" + id,
                type: "GET",
                dataType: "json",
                success: function(data) {
                    if (data) {
