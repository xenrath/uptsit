                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <a href="{{ url('user/perangkat/scan') }}" class="btn btn-outline-info btn-sm btn-flat">
                                Scan
                            </a>
                            <a href="{{ url('user/perangkat/create') }}" class="btn btn-primary btn-sm btn-flat">
                                Tambah
                            </a>
                        </div>
                    </div>
                                ...
                                @forelse ($perangkats as $perangkat)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ url('user/perangkat/' . $perangkat->id) }}"
                                                class="btn btn-info btn-sm btn-flat">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ url('user/perangkat/' . $perangkat->id . '/edit') }}"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer justify-content-between">
                                                    ...
                                                    <form action="{{ url('user/perangkat/print/' . $perangkat->id) }}"
                                                        method="post">
                                                        @csrf
                                                        <button type="submit"
